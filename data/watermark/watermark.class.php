...
function WaterMark($groundimage, $markimage, $markminwidth, $markminheight, $markwhere='0', $marktext='',
                   $fontfamily, $fontsize='15', $fontcolor="#000", $marktype=0)
{


	//配置水印图片文件
	if(!file_exists($markimage))
		$markimage = 'data/watermark/watermarket.png';
