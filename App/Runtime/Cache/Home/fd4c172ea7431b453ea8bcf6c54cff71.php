...
<body>
    ...
    <div id="banner" class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="JavaScript:;">
                    <img src="/public/wy/images/banner1.jpg" alt="">
                </a>
            </div>
            <div class="swiper-slide">
                <a href="javascript:;">
    ...
    <div class="container special">
        <div id="ceramics">
            <div class="left">
                <h3>Ceramics</h3>
                <p>Special field assembles and sells the Wei bath product and the accessory</p>
            </div>
            <div class="right">
                <?php if(is_array($list1)): $i = 0; $__LIST__ = $list1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l1): $mod = ($i % 2 );++$i;?><a href="index.php?m=product&a=detail&id=<?php echo ($l1["id"]); ?>">
                        <img src="<?php echo ($l1["picurl"]); ?>" alt="">
                        <span><?php echo ($l1["title"]); ?></span>
    ...
    <div class="container">
        <div id="Sanitary">
            ...
            <div class="right">
                <?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l2): $mod = ($i % 2 );++$i;?><a href="index.php?m=product&a=detail&id=<?php echo ($l2["id"]); ?>">
                        <img src="<?php echo ($l2["picurl"]); ?>" alt="">
                        <span><?php echo ($l2["title"]); ?></span>
                    </a><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="container con_about">
        <div   id="content">
            <div class="about">
                <p class="about_title">BATHROOM PRODUCTS FROM FAENZA OFFER <br> ADDED VALUE</p>
                <p class="about_img"><img src="/public/wy/images/about1.png" alt=""></p>
                <p class="about_txt">In regards to the long lifetime of a bathroom, many people, In regards to the long lifetime of a bathroom, many people, In regards to the long lifetime of a bathroom, many people, In regards to the long lifetime of a bathroom, many people, inc</p>
                <i>Step Inside Our Company And Our Culture.</i>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            var $bannerHeight = 652 * (document.body.clientWidth / 1920)+"px";
